...
import com.hotel.Factory.ReservasFactory;
...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				if ("date".equals(evt.getPropertyName())) {
					//Evitar que pueda ser seleccionado una fecha anterior a la de entrada.
					...
					txtFechaSalida.setMinSelectableDate(fechaSalida);
					//Calculo del valor de reserva.
		...
		txtValor.setBounds(100, 328, 50, 33);
		...
		btnnext.setBounds(238, 493, 120, 35);
		panel.add(btnnext);
	...
	private void calcularValorReserva() {
        ...
        if (fechaEntrada != null && fechaSalida != null) {
            ...
            int valorPorDia = 100;
            int valorTotal = dias * valorPorDia;

			txtValor.setText(Integer.toString(valorTotal));
        }
    }

	private void guardaDatos() {
		ReservasFactory reservasFactory = new ReservasFactory();
		
        Reservas reserva = new Reservas();

		LocalDate fechaEntrada = getSelectedDate(txtFechaEntrada);
		LocalDate fechaSalida = getSelectedDate(txtFechaSalida);
		...
		reserva.setFormaPago(FormaDePago);
		reservasFactory.persist(reserva);
	}
